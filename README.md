...
Automated 50-design parametric aerodynamic trade study and preliminary design optimization for a Cessna 172-class general aviation wing using **XFLR5 (VLM/LLT & 3D Panel Method)** and automated **MATLAB data extraction and visualization pipelines[cite: 1].
